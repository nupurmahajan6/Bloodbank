...
insert  into `notificationdonors`(`hospital`,`bloodgroup`,`address`,`location`,`input_details`,`input_time_confirm`,`email`,`status`,`rewards`,`username`) values ('Ghatkopar ','AB-','sangarsh nagar','mumbai','you are eligible for this ','6:09','rmundekar2000@gmail.com','succesful_donaton','25','a');
